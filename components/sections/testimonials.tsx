...
const reviews = [
  { name: "Tina Merolla", time: "2 anni fa", text: "Faccio questa recensione per elogiare il meraviglioso lavoro fatto dai maestri ogni giorno sui nostri figli. Un lavoro fatto di amore, dedizione, pazienza e rispetto. Centro Danza e una scuola da consigliare per la bravura dei professionisti che ci lavorano e per lattenzione costante verso famiglie e allievi." },
  { name: "Amedeo Buono", time: "2 anni fa", text: "Sono il papa di una allieva e da quando mia figlia e iscritta a Centro Danza ha una luce diversa negli occhi. La danza e sempre stata la sua passione, ma qui ha trovato un ambiente gentile, professionale e capace di farla crescere con entusiasmo." },
    ...
    <section className="bg-[#050505] py-20 sm:py-28">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="mb-14 px-4 text-left lg:px-0 lg:text-center">
          ...
          <p className="max-w-none text-lg text-pretty text-muted-foreground lg:mx-auto lg:max-w-2xl">Le parole di chi vive ogni giorno l&apos;esperienza Centro Danza.</p>
        </div>
        ...
        <div className="mt-12 text-center">
          <a href="https://maps.google.com/?q=Via+Giuseppe+Martucci+35B+80121+Napoli" target="_blank" rel="noopener noreferrer" className="inline-flex rounded-full border-2 border-[#D4AF37]/70 px-8 py-3 font-semibold text-white transition-all hover:bg-[#D4AF37] hover:text-[#050505]">Leggi tutte le recensioni su Google</a>
        </div>
      </div>
    </section>
  )
